...
<input type="button" value="Tampil semua data" onclick="window.open('<?php echo base_url()."adm/tampil_absen/"; ?>', '_self');" class="btn btn-info">
<input type="button" value="Rekap Data Absen" onclick="window.open('<?php echo base_url()."adm/tampil_absen/"; ?>', '_self');" class="btn btn-success">
<!--
...
<div class="alert alert-info">
	<b>Data yang ditampilkan adalah data hari ini, tanggal <?php echo tgl_jam_sql(date('Y-m-d')); ?></b>
</div>
...
?>
	<tr>
		...
		<td class="ctr">
			<a href="<?php echo base_url(); ?>adm/data_absensi/hapus/<?php echo $d->id; ?>" class="label label-danger" onclick="return confirm('Anda yakin..?');">Hapus</a>
		</td>
	</tr>
<?php 
	}
