...
<div class="panel panel-default" id="panel_kanan">
                ...
                <div class="magazine-sb-social margin-bottom-35">
                   ...
                   <!-- <div class="headline headline-md"><h2><i class="fa fa-user"></i> Ka. Sekolah </h2><hr class="style2"></div>-->
                    <div class="">
						...
						<p>
						<p align="center"><strong><em> <img class="thumbnail" src="<?php echo $this->config->item('foto_kepala'); ?>" alt="Siti Rosidah, S.Pd" width="159" height="210" /> </em></strong></p>
						...
						<p align="justify">Kami ucapkan selamat datang dan terima kasih yang sebesar-besarnya karena Anda telah berkunjung di&nbsp;<strong>website SMP Negeri 2 Moyudan</strong>. 
