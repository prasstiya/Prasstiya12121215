...
<div class="col-md-9">
	...
	<div class="panel panel-warning" style="margin-left: -30px">
			<div class="panel-heading">
				<h4><i class="fa fa-picture-o"></i> Data Nilai </h4>
			</div>
			<div class="panel-body">
				<div class="col-md-12 panel-body" style="margin: 0px auto">
					<div class="form-group">
					<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>web/data_nilai/">
						<div class="form-group col-md-6">
							<input type="text" name="cari" class="form-control" placeholder="Masukkan NIS ..." value="<?php echo $this->input->post('cari'); ?>" required>
						</div>
				...
				<div class="alert alert-success">Masih dalam proses </div>
